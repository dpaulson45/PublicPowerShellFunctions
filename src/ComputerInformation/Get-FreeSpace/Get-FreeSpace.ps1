Function Get-FreeSpace {
    ...
    <#
    Required Functions:
        https://raw.githubusercontent.com/dpaulson45/PublicPowerShellFunctions/master/src/Common/Write-VerboseWriters/Write-InvokeCommandReturnVerboseWriter.ps1
        https://raw.githubusercontent.com/dpaulson45/PublicPowerShellFunctions/master/src/Common/Write-HostWriters/Write-InvokeCommandReturnHostWriter.ps1
    #>
